    ...
    <div class="px-6 py-5">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                <svg class="w-8 h-8 text-yellow-500" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                ...
                <a href="{{ route('dashboard') }}">
                    <h1 class="text-3xl md:text-4xl font-[Pacifico] font-extrabold text-yellow-600 tracking-tight hover:scale-105 transition-transform">
                    My Delicious Blog
                    </h1>
                </a>    
            </div>
