            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="/assets/img/logo.jpeg" class="block h-16 w-auto fill-current text-gray-800 "/>
                    </a>
                </div>
                ...
                <div class= "hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('recipe.index')" :active="request()->routeIs('recipe.index')">
                        <span class="py-4 text-lg font-semibold text-yellow-500">{{ __('Explorar recetas') }}</span>
                    </x-nav-link>
